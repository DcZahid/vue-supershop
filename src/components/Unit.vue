...
export default {
    ...
    methods: {
        ...
        save() {
            axios.post("http://127.0.0.1:8000/api/unit", {name: this.name })
                .then((response) => {
                    this.name
                    this.getUnit()
                    this.name = ""
        ...
        showUni(id) {
            this.id = id
            axios.get("http://127.0.0.1:8000/api/unit/" + id + '/edit')
                .then((response) => {
        ...
        updateUnit() {
            axios.put("http://127.0.0.1:8000/api/unit/" + this.id, { name: this.name })
                .then((response) => {
        ...
        deleteUnit(id) {
            axios.delete("http://127.0.0.1:8000/api/unit/" + id)
            .then(() => {
