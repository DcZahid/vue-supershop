...
export default {
    ...
    methods: {
        ...
        save() {
            axios.post("http://127.0.0.1:8000/api/payment", {method: this.method })
                .then((response) => {
                    this.method
                    this.getPayment()
                    this.method = ""
        ...
        showPayment(id) {
            this.id = id
            axios.get("http://127.0.0.1:8000/api/payment/" + id + '/edit')
                .then((response) => {
        ...
        updatePayment() {
            axios.put("http://127.0.0.1:8000/api/payment/" + this.id, { method: this.method })
                .then((response) => {
