...
export default {
    ...
    methods: {
        ...
        save() {
            axios.post("http://127.0.0.1:8000/api/product",{ name:this.name,category_id:this.category_id,sub_category_id:this.sub_category_id,brand_id:this.brand_id})
                .then((response) => {
                    this.category_id='',
                ...
                //    this.$router.push('../components/Product/ProductList.vue')
                });
        },
    },
    mounted() {
